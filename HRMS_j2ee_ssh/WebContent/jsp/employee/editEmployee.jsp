		...
		<div id="content">
			...
			<div id="left">
				...
				<div align="center">
					...
					<s:form id="saveForm" action="employee_edit" method="post"
						...
						<table style="font-size: :16px">
							<tr>
								...
								<td><s:radio list="{'男','女'}" value="%{model.sex}"
										name="sex" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><s:password value="%{model.password}" name="password"
							...
							<tr>
								...
								<td><s:select name="department.did" headerKey="0"
										value="%{model.department.did}" headerValue="--请选择--"
										list="list" listKey="did" listValue="dname" /></td>
							</tr>
						</table>
					</s:form>
					<table border="0" width="900px">
