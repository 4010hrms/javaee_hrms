			...
			<div id="left">
				...
				<div align="center">
					<table border="0" width="900px">
						...
						<tr>
							<td align="right"><a
								href="task_goAddTask.action">添加任务</a></td>
						</tr>
						<tr>
							<td align="right">
							<form action="task_search" method="post">
							<input type="text" name="tname" placeholder="请输入员工名称" required maxLength="20">
									...
									<tbody>
										<s:iterator value="list" var="t">
											<tr>
												...
												<td align="center">
												    <a href="task_findById.action?tid=<s:property value="#t.tid"/>">
												       <img src="${pageContext.request.contextPath }/images/mark.png" />
												    </a>
												</td>
												<td align="center">
												    <a href="task_delete.action?tid=<s:property value="#t.tid"/>">
									...
									<tr>
										...
										<span>
										   <s:if test="currPage != 1">
												<a href="task_findAll.action?currPage=1">[首页]</a>&nbsp;&nbsp;
							                    <a href="task_findAll.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
							               </s:if> 
							               <s:if test="currPage != totalPage">
												<a href="task_findAll.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
							                    <a href="task_findAll.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
							               </s:if> 
							            </span>
							            </td>
									</tr>
