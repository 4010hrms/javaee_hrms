			...
			<div id="left">
				...
				<div align="center">
					<table border="0" width="900px">
						<tr>
							<td align="center" style="font-size: 24px; color: #666">任务添加</td>
						</tr>
						<tr>
					...
					<s:form id="saveForm" action="task_saveTask"
						method="post" namespace="/" theme="simple">
						<table border="0" width="900px">
							<tr>
							<td width="30%" align="right">任务编号：</td>
							<td><s:textfield name="tno" /></td>
							</tr>
							<tr>
							<td width="30%" align="right">执行员工：</td>
							...
							<td><s:textarea rows="5" cols="50" name="tcontent" ></s:textarea></td>
							</tr>
						</table>
					</s:form>
					<br/>
					...
					<table border="0" width="900px">
						<tr>
							<td align="center" style="font-size: 24px; color: #666">操作</td>
						</tr>
						<tr>
							<td align="right">
