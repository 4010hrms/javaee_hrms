			...
			<div id="left">
				...
				<div align="center">
					<table border="0" width="900px">
						<tr>
							<td align="center" style="font-size: 24px; color: #666">假条申请</td>
						</tr>
						<tr>
					...
					<s:form id="saveForm" action="aleave_personsavealeave" method="post" namespace="/" theme="simple">
		<table border="0" width="900px">
			<tr>
				<td width="30%" align="right">员工编号</td>
				<td><s:textfield name="eid" value="%{#session.theperson.eid}" disabled="true"/></td>
			</tr>
