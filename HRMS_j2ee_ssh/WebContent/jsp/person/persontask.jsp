			...
			<div id="left">
				...
				<div align="center">
					<table border="0" width="900px">
						<tr>
							<td align="center" style="font-size: 24px; color: #666">任务查看</td>
						</tr>
					...
					<table border="0" width="900px">
						...
						<tbody>
			<s:iterator value="#session.personlist" var="task">
				<tr>
					<td align="center"><s:property value="#task.tno" /></td>
					<td align="center"><s:property value="#task.eid" /></td>
					<td align="center"><s:property value="#task.tname" /></td>
					<td align="center"><s:property value="#task.taskname" /></td>
					<td align="center"><s:property value="#task.tcontent" /></td>
